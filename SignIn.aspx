<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignIn.aspx.cs" Inherits="E_Commerce_First.SignIn" %>
            ...
            <div class ="form-horizontal ">
                ...
                <div class ="form-group">
                    ...
                    <div class ="col-md-3 ">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorUserEmail" runat="server" CssClass ="text-danger " ErrorMessage="*plz Enter Email" ControlToValidate="txtEmail" ForeColor="Red"></asp:RequiredFieldValidator>
                    </div>
                </div>
